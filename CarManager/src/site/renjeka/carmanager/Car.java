...
public abstract class Car implements Serviceable {
	...
	public void addDistance(int additionalDistance) throws Throwable {
		if(additionalDistance < 0) {
			throw new Exception("Distance must be less than 0 !");
		}
	...
	public void addDistance(double additionalDistance) throws Throwable {
		...
		this.distance = (int) (this.distance + Math.round(additionalDistance)) ;
		this.distanceOnService = (int) (this.distanceOnService + Math.round(additionalDistance));
